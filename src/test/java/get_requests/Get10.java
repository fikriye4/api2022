...
public class Get10 extends GoRestBaseUrl {
        ...
        /*
          ...
          23 teki kodu Burdaki null'obje atayarak yapıyoruz
          Tum map aliyoruz null tanımsız deger oldugu icin Stringe koyamayız objeye koyacagız
       */
    ...
    public void get01(){
        ...
        Map<String , String> dataKeyMap = dataKey.dataKeyMap("Chanakya Varman", "chanakya_varman@bosco.org","female","active");//İç Map'i oluşturuyorum.
